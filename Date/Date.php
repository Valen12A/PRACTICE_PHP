...
//Transforma a una fecha legible un timestamp
...
//Traduce el tiempo a español o ingles según se especifique, por ejemplo: "1 día" a inglés da: "1 day" y viceversa 
...
//Añade la cantidad de tiempo indicada a un timestamp, si indicas "now" tomará la fecha actual, como segundo parámetro recibe la cantidad de tiempo a añadir en español, por ejemplo, "1 año", "7 dias", "4 semanas", etc... 
...
//Resta dos fechas en formato tiemstamp y retorna un DateInterval 
...
//Retorna si una hora dada está entre dos horas, recibe la hora inferior, la superior y la hora que se verificará 
...
//Retorna si una fecha está entre dos fechas, recibe la hora inferior, la superior y la fecha que se verificará 
...
//Obtiene una fecha entera a partir de un timestamp 
...
//Convierte Timestamp de JavaScript a Timestamp de PHP -
...
//Obtiene una fecha entera a partir de un timestamp de JavaScript 
